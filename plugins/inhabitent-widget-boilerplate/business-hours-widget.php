 ...
 * @author    Dom Yan <dominiqueyyan@gmail.com>
 * @license   GPL-2.0+
 * @link      http://tent.academy.red.com
 * @copyright 2019 RED Academy
 *
 * @wordpress-plugin
 * Plugin Name:       Inhabitent Business Hours Widget
 * Plugin URI:        https://github.com/DominiqueYan/Project4Inhabitent
 * Description:       A widget that displays business hours for the inhabitent website
 * Version:           1.0.0
 * Author:            Dom Yan
 * Author URI:        https://github.com/DominiqueYan/
 * License:           GPL-2.0+
